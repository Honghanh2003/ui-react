  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className='font-bold sm:text-[32px] text-[36px] text-white'>
            Samantha
          </h4>
        ...
        <p className='mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[32px] leading-[39px] text-white'>
